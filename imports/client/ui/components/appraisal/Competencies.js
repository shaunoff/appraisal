...
render(){
  ...
  return(
    ...
    <div style={{display: 'flex', flexDirection: 'column',margin: '15px',flex: '3', display: 'flex',border: "2px solid #ccc", borderRadius: '8px',background: "white"}}>
        ...
        <Rating value={employee.commRating} name="commRating" validations="isExisty" required/>
        <Comment value={employee.commComment} rows={4} name="commComment" validations="isExisty" required/>
      </div>
      <div style={{display: 'flex', flexDirection: "column"}}>
      <div style={{fontSize: "14px", fontWeight: '700', color: '#6bada7',padding:"10px"}}>
      ...
      <Rating value={employee.coopRating} name="coopRating" validations="isExisty" required/>
      <Comment value={employee.coopComment} rows={4} name="coopComment" validations="isExisty" required/>
    </div>
    <div style={{display: 'flex', flexDirection: "column"}}>
    <div style={{fontSize: "14px", fontWeight: '700', color: '#6bada7',padding:"10px"}}>
    ...
    <Rating value={employee.judgeRating} name="judgeRating" validations="isExisty" required/>
      <Comment value={employee.judgeComment} rows={4} name="judgeComment" validations="isExisty" required/>
    ...
    <div style={{fontSize: "14px", fontWeight: '700', color: '#6bada7',padding:"10px"}}>
      ...
      <Rating value={employee.timeRating} name="timeRating" validations="isExisty" required/>
      <Comment value={employee.timeComment} rows={4} name="timeComment" validations="isExisty" required/>
    </div>
